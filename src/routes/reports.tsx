...
function downloadPDF(title: string, data: any[]) {
  ...
  doc.text(`Generated by CropVision AI - ${new Date().toLocaleDateString()}`, 14, 22);
...
function downloadXLSX(title: string, data: any[]) {
  if (!data.length) return;
  ...
  return (
    <AppLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {[
          { title: "Executive Summary", icon: FileText, format: "PDF", desc: "Area statistics at village level for policy formulation." },
          ...
          return (
            <div key={r.title} className="glass rounded-xl p-5">
              ...
              <button onClick={() => r.format === "PDF" ? downloadPDF(r.title, data) : downloadXLSX(r.title, data)}
